...
function addZoomControls() {
  ...
  const headerBar = zoomControls.append("div")
...
function saveZoomControlsState() {
  ...
  if (!zoomControls.empty()) {
    zoomControlsMinimized = d3.select("#zoom-controls-content").style("display") === "none";
  }
}
